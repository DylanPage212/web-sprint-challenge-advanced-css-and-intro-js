...
Making your website as usable by as many people as possible.
2. Talk about 3 different things you can do to ensure your website is accessible. 
using rems for font size, semantic html, responsive design
3. How would you explain the concept of a variable to someone new to programming?
it's a box in which you can store many different kinds of code. You can refer to all of the code by using the name of the box.
4. What is the purpose of using functions in code?
reusable code, responsive code
